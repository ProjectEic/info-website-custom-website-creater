...
const Impressum = () => {
  ...
  return (
    <div className="Impressum p-8">
      ...
      <p className="mb-2">Jakob Rinke<br/>Am Heidenhang 2<br/> Dingelstädt 37351<br/> Deutschland </p>

      <p className="mb-2"><b>Kontakt:</b></p>
      <p className="mb-2">Telefon: +49 152 02861103<br/>E-Mail: <a href="mailto:projecteic.contact@gmail.com">projecteic.contact@gmail.com</a></p>
      ...
      <p className="mb-2">Unsere Datenschutzerklärung finden Sie <Link className="underline hover:text-gray-400 cursor-pointe" href="/datenschutz">hier</Link>.</p>
